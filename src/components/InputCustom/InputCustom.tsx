...
import { Animated, StyleSheet, Text, TextInput, TouchableOpacity, View,StyleProp, ViewStyle } from 'react-native';
...
const CustomInput = ({ containerStyle, placeholder, onChangeText, error, ...props }:PropsInput) => {
